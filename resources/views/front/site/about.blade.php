...
@section('content')
    <div class="text-sm p-1 m-1 place-self-start">
        Vous êtes ici : <span class=" border-b-2 border-yellow-400"> BDFI <span class="text-xs">Maquette de test</span> &rarr; Site BDFI &rarr; A propos</span>
    </div>

    <x-menu-site tab='about' />

    <div class='text-2xl font-bold pt-2 mt-2 self-center'>
        A propos de BDFI
    </div>

    <div class='text-base pt-2 mt-5 mx:2 md:mx-20'>
        Le site <span class="font-bold text-red-800">BDFI</span> a été créé début 2001 par Christian Moulin et Gilles Richardot. Il fait suite et a remplacé le site <span class="font-bold italic text-red-800">Imagine...</span> qui était apparu en ligne deux ans auparavant, en juin 1999.
    </div>

    <div class='text-xl font-bold text-purple-900 pt-2 mt-5 mx:2 md:mx-20'>Membres actifs</div>
    <div class='text-base pt-1 mt-1 mx:4 md:mx-20'>
    ...
    <div class='text-xl font-bold text-purple-900 pt-2 mt-5 mx:2 md:mx-20'>Remerciements particuliers</div>
    <div class='text-base pt-1 mt-1 mx:4 md:mx-20'>
    ...
    <div class='text-xl font-bold text-purple-900 pt-2 mt-5 mx:2 md:mx-20'>Techniques</div>
    <div class='text-base p-2 m-5 mx:4 md:mx-20 bg-yellow-200 border-l-4 border-red-600'>
        Etant donné les chantiers en cours concernant cette partie-là, elle sera réécrite en fin de travaux.
    </div>
