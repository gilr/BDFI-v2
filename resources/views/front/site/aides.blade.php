...
@section('content')
    <div class="text-sm p-1 m-1 place-self-start">
        Vous êtes ici : <span class=" border-b-2 border-yellow-400"> BDFI <span class="text-xs">Maquette de test</span> &rarr; Site BDFI &rarr; Aides</span>
    </div>

    <x-menu-site tab='aides' />

    <div class='text-2xl font-bold pt-2 mt-2 self-center'>
        Et si je souhaite vous aider ? - How can I help?
    </div>
    ...
    <div class='text-xl font-bold text-purple-900 pt-2 mt-5 mx:2 md:mx-20'>Auteur - Writer</div>
    <div class='text-base p-1 md:px-10 mt-1 mx:4 md:mx-20 border-b border-red-500'>
    ...
    <div class='text-base p-1 mt-1 md:px-10 mx:4 md:mx-20'>
        ...
        If you want to contribute, please send an e-mail to C. Moulin et G. Richardot.<br />
        Many thanks!
    </div>

    <div class='text-xl font-bold text-purple-900 pt-2 mt-5 mx:2 md:mx-20'>Passionnés</div>
    <div class='text-base p-1 md:px-10 mt-1 mx:4 md:mx-20'>
    ...
    <div class='text-xl font-bold text-purple-900 pt-2 mt-5 mx:2 md:mx-20'>Fanéditeur</div>
    <div class='text-base pt-1 md:px-10 mt-1 mx:4 md:mx-20'>
