<div>
	<aside class="bg-gradient-to-r from-gray-300 to-gray-50 flex flex-col items-center bg-yellow-100 text-gray-700 shadow h-full">
		...
		<div class="h-16 flex items-center w-full">
			<!-- Logo Section -->
			<a class="mx-auto p-2 text-yellow-600 bold bg-yellow-100 border border-2 border-yellow-400 rounded-full shadow" href="/">
				BDFI
			</a>
		</div>
		...
		<ul>
			...
			<li class="hover:bg-yellow-100">
				<a href="/auteurs" class="h-16 px-4 flex flex justify-center items-center w-full focus:text-yellow-600" title="Les auteurs">
			...
			<li class="hover:bg-yellow-100">
				<a href="/ouvrages" class="h-16 px-4 flex flex justify-center items-center w-full focus:text-yellow-600" title="Les ouvrages">
					<img src="/img/livre.png" style="width: 40px" />
				</a>
			</li>

			<li class="hover:bg-yellow-100">
				<a href="/series" class="h-16 px-4 flex flex justify-center items-center w-full focus:text-yellow-600" title="Les cycles et séries">
					<img src="/img/series.png" style="width: 40px" />
				</a>
			</li>

			<li class="hover:bg-yellow-100">
				<a href="/editeurs" class="h-16 px-4 flex flex justify-center items-center w-full focus:text-yellow-600" title="Les éditeurs">
					<img src="/img/editeurs.png" style="width: 40px" />
				</a>
			</li>

			<li class="hover:bg-yellow-100">
				<a href="/collections" class="h-16 px-4 flex flex justify-center items-center w-full focus:text-yellow-600" title="Les collections">
		...
		<div class="mt-auto h-16 flex items-center w-full">
			...
			<button
				...
				w-full focus:text-yellow-600 hover:bg-yellow-100 focus:outline-none">
				<svg
